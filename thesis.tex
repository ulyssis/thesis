...
%{./figures/03_distributedChannelAllocation/figures_from_report/}
...
%% put the glossaries in thesis.tex

\newglossaryentry{crn}{name=CRN, description={Cognitive Radio Network}}
...
\include{backmatter/00_title}
\cleardoublepage
\include{backmatter/00_statement}
\cleardoublepage
\include{backmatter/00_abstract}
\cleardoublepage
\include{backmatter/00_acknowledgments}
\cleardoublepage
\include{backmatter/00_publications}
\cleardoublepage
...
\include{chapters/03_distributedChannelAllocation}
\include{chapters/04_clutering}
\include{chapters/05_routing}
...
%\include{backmatter/07_glossary}
...
\bibliography{./backmatter/myrefs}				%Eine Datei 'literatur.bib' wird hierfür benötigt.
