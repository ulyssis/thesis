...
In this regard, a WBS should work on proper channels and with suitable transmission power according to its location and the locations of DTT receivers.
...
\label{SystemModel}
We consider a group of WSDs which work with the master/slave model.
We assume there is one database in our considered model.
The WSDs which work as masters can access the database to obtain permitted channel and associated maximum transmission power.
...
To protect them from harmful interference generated by the WSD devices, a series of interference measurement devices are deployed at the contour of the DTT service area.
Their location and the upper bound of interference are known by the database.
...
The considered system is shown as Figure~\ref{sysmodel}
