...
\subsubsection*{CRN Working with TV White Space}
\label{TVWS}
...
The concrete technical challenges addressed in this thesis are shown in Figure~\ref{problemLocation}, which reside from physical layer to network layer~\cite{osi}. 
...
Based on the description on the challenges, we formulate three research questions which will be answered in this thesis.
