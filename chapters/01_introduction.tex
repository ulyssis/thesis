...
When the problems can not be formulated into linear programming, or convex programming problems where optimal is difficult to obtain, certain heuristic methods are available to find out the solution which  approaches to the optimal, \eg simulated annealing [xxx], generic algorithm [xxx], and ant algorithm etc.
