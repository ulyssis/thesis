...
\subsubsection{CRN Working in TV White Space}
\label{TVWS}
...
Thus distributed scheme is also necessary in the utilization of TV white spectrum.
...
Question 1 - When distributed algorithms are necessary due to the specific properties of one problem, how to guarantee the convergence and performance? How to design utility function to make use of game model in the process of algorithm design?

Question 2 - What are the strengths and weaknesses of the distributed algorithm compared with the centralized scheme?
...
Contribution C1 - We apply congestion game in the new domains, and design distributed schemes which comply with the behaviours of players of the congestion game.
...
Contribution C2 - We compare the performance of distributed schemes and centralized schemes in concrete problems in CRN.
...
This thesis doesn't chase the properties of games, but make use of the available knowledge of game, and apply them to solve the pressing challenges existing in cognitive radio networks.
