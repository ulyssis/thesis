...
Spectrum sharing is composed with two sub problems, the spectrum sharing between the primary users and secondary users, and that among the secondary users.
...
\subsection{Operation model of spectrum sharing in CRN}
...
When the problems can not be formulated into linear programming, or convex programming problems where optimal is easy to obtain, certain heuristic methods are available to find out the solution which  approaches to the optimal, \eg simulated annealing [xxx], generic algorithm [xxx] and ant algorithm etc.
