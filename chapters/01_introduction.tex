...
Under the game theoretic framework, we can analysis the interaction among the users which operate according to the algorithm, and check whether the system reaches a desirable equilibrium, \ie the individuals also improve the global welfare of the complete system.
