...
%[clustering in crn] 
For instance, clustering is regarded as an effective method used in cooperative spectrum sensing~\cite{Sun07_clustering_spectrum_secsing, Zhao07}.
...
Except for the advantages brought in by clustering, there is a issue on clustering structure itself in cognitive radio network.
...
\begin{figure}[ht!]
  \centering
  \includegraphics[width=0.67\linewidth]{number_clusters_scale.pdf}
...
Q = \bordermatrix{~ 		& 1 	& 2 	& 3 	& \cdots 	& n-1 	& n	\cr
                  C_1 	& k_{C_1} 	& k_{C_1} 	& 0 	& \cdots 	& 0 	& 0	\cr
                  C_2 	& k_{C_2} 	& 0 	& k_{C_2} 	& \cdots 	& 0 	& 0	\cr
				\vdots  	&\vdots & 	 	& 		&  \vdots		& 		& \vdots \cr
				C_i 	& 0 	& k_{C_i} 	& 0 	& \cdots 	& k_{C_i} 	& 0	\cr
				\vdots  	&\vdots & 	 	& 		&  \vdots		& 		& \vdots \cr
				C_{i'} 	& k_{C_{i'}} 	& 0 	& 0 	& \cdots 	& k_{C_{i'}} 	& 0	\cr
				\vdots  	&\vdots & 	 	& 		&  \vdots		& 		& \vdots \cr}	
\caption{Matrix Q}
\label{xx}
\end{figure}
...
\begin{align}
   &  \text{minimize}
   && \Sigma_{j=1}^g\Sigma_{i=1}^n (-x_{ij}q_{ij} + w_i*\texttt{cost($\delta$)}) \\
   &  \text{subject to}
   && \Sigma_{i=1}^g x_{ij} = 1,  j=1, \ldots, n \\
   &
...
\begin{figure}[ht!]
  \centering
  \includegraphics[width=0.8\linewidth]{size_control_20.pdf}
...
\begin{center}
%\centering
\subfigure[100 CRns, 30 PRns]{\label{result1:1}\includegraphics[width=0.48\linewidth]{size_distribution_100.pdf}}
\subfigure[300 CRns, 30 PRns]{\label{result1:2}\includegraphics[width=0.48\linewidth]{size_distribution_300.pdf}}
\end{center} 
