\chapter{Congestion Game in Cluster Membership Assignment}
...
%
\subfigure[SOC]{\includegraphics[width=0.45\textwidth]{final_clustering_soc}\label{fig:final_clustering_soc}}
\subfigure[Linear programming]{\includegraphics[width=0.45\textwidth]{final_clustering_LP}\label{fig:final_clustering_LP}}
\end{center}
