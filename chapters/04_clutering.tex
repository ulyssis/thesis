...
Q = \bordermatrix{~ 		& 1 	& 2 	& 3 	& \cdots & j & \cdots	& n-1 	& n	\cr
                  C_1 	& k_{C_1} 	& k_{C_1} 	& 0 	& \cdots & \cdots &\cdots	& 0 	& 0	\cr
                  C_2 	& k_{C_2} 	& 0 	& k_{C_2} 	& \cdots & \cdots & \cdots 	& 0 	& 0	\cr
				\vdots  	&\vdots & 	 	& 		&  \vdots		& 		& \vdots \cr
				C_i 	& 0 	& k_{C_i} 	& 0 	& \cdots  & \cdots & \cdots 	& k_{C_i} 	& 0	\cr
				\vdots  	&\vdots & 	 	& 		&  \vdots & \cdots & \cdots 		& 		& \vdots \cr
				\vdots 	& \vdots  	& 0 	& 0 	& \cdots & \cdots & \cdots 	& k_{C_{i'}} 	& 0	\cr
				C_{g}  	& k_{C_{g}} & 	 	& 		&  \vdots	& \cdots & \cdots& 	& 		& \vdots \cr}	
\caption{Matrix Q}
\label{xx}
\end{figure}
