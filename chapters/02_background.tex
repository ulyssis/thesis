...
IEEE 802.19 is a family of IEEE 802 standards in Wireless Coexistence Working Group, among which, IEEE 802.19.1~\cite{802.19} is for coexistence methods among local and Metropolitan Area Networks (\gls{MAN}).
IEEE 802.11af~\cite{802.11af} is standards for WLAN operation in TVWS, IEEE 802.15.4m~\cite{802.15.4m} is for low rate (LR) WPAN operating in TVWS. 
IEEE 802.22~\cite{802.22} is for Wireless Regional Area Networks (\gls{WRAN}) using TVWS. 
